...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI1.Entities.AgentConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebAPI1.Entities.AgentConversationMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebAPI1.Entities.AgentDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SourceSuggestFileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI1.Entities.AgentLiteLlmSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("StreamRequestBudgetSeconds")
                        .HasColumnType("float");

                    b.Property<string>("Tier1Model")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.ToTable("AgentLiteLlmSettings");
                });

            modelBuilder.Entity("WebAPI1.Entities.AgentMcpEndpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OAuthAccessTokenEncrypted")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("OAuthAccessTokenExpiresAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("OAuthAuthorizationServer")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AgentMcpEndpoints");
                });

            modelBuilder.Entity("WebAPI1.Entities.AgentPromptSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ShowToolCallDetailsToUsers")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("AgentPromptSettings");
                });

            modelBuilder.Entity("WebAPI1.Entities.AgentTool", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ExternalAccessEnabled")
                        .HasColumnType("bit");

                    b.Property<bool>("IsEnabled")
                        .HasColumnType("bit");

                    b.Property<int?>("McpEndpointId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI1.Entities.AgentToolRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ToolId", "RoleId")
                        .IsUnique();

                    b.ToTable("AgentToolRoles");
                });

            modelBuilder.Entity("WebAPI1.Entities.McpOAuthClient", b =>
                {
            ...
            modelBuilder.Entity("WebAPI1.Entities.McpAuthorizationCode", b =>
                {
            ...
            modelBuilder.Entity("WebAPI1.Entities.McpRefreshToken", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebAPI1.Entities.GeminiSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI1.Entities.KpiDetailItemMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("NewDetailItemId")
                        .HasColumnType("int");

                    b.Property<int>("NewKpiItemId")
                        .HasColumnType("int");

                    b.Property<int?>("OldDetailItemId")
                        .HasColumnType("int");

                    b.Property<int>("OldKpiItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NewDetailItemId");

                    b.HasIndex("NewKpiItemId");

                    b.HasIndex("OldDetailItemId");

                    b.HasIndex("OldKpiItemId");

                    b.ToTable("KpiDetailItemMappings");
                });

            modelBuilder.Entity("WebAPI1.Entities.KpiDetailItemMappingGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KpiDetailItemMappingGroups");
                });
            ...
            modelBuilder.Entity("WebAPI1.Entities.KpiReportSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KpiDataId");

                    b.ToTable("KpiReportSnapshots");
                });

            modelBuilder.Entity("WebAPI1.Entities.LoginLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebAPI1.Entities.MailLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime?>("BounceAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<string>("BounceCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BounceReason")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("BounceStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI1.Entities.ReportPeriodSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReportPeriodSettings");
                });
            ...
            modelBuilder.Entity("WebAPI1.Entities.SuggestSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI1.Entities.SystemAnnouncement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPI1.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("FormaRegistered")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("WebAPI1.Entities.AgentConversationMessage", b =>
                {
                    b.HasOne("WebAPI1.Entities.AgentConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("WebAPI1.Entities.AgentToolRole", b =>
                {
                    ...
                    b.HasOne("WebAPI1.Entities.AgentTool", "Tool")
                        .WithMany("AgentToolRoles")
            ...
            modelBuilder.Entity("WebAPI1.Entities.KpiDetailItemMapping", b =>
                {
                    b.HasOne("WebAPI1.Entities.KpiDetailItemMappingGroup", "Group")
                        .WithMany("Mappings")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPI1.Entities.KpiDetailItem", "NewDetailItem")
                        .WithMany()
                        .HasForeignKey("NewDetailItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("WebAPI1.Entities.KpiItem", "NewKpiItem")
                        .WithMany()
                        .HasForeignKey("NewKpiItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebAPI1.Entities.KpiDetailItem", "OldDetailItem")
                        .WithMany()
                        .HasForeignKey("OldDetailItemId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("WebAPI1.Entities.KpiItem", "OldKpiItem")
                        .WithMany()
                        .HasForeignKey("OldKpiItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Group");

                    b.Navigation("NewDetailItem");

                    b.Navigation("NewKpiItem");

                    b.Navigation("OldDetailItem");

                    b.Navigation("OldKpiItem");
                });
